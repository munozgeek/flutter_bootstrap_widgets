...
class _IconsPageState extends State<IconsPage> {
  ...
  final _iconInfos = [
    ...
    {'icon': Icons.class_outlined, 'name': 'class_outlined'},
    {'icon': Icons.class_rounded, 'name': 'class_rounded'},
    {'icon': Icons.class_sharp, 'name': 'class_sharp'},
    ...
    {'icon': Icons.pie_chart_outline, 'name': 'pie_chart_outline'},
